...
string1 = _("By event")
# Translators: One of several options for specifying how often data is collected or reported on over the life of a program
string2 = _("Final evaluation")
# Translators: One of several options for specifying how often data is collected or reported on over the life of a program
string3 = _("By training")
# Translators: One of several options for specifying how often data is collected or reported on over the life of a program
...
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string76 = _("Employment")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string77 = _("Environment (DRR, Energy and Water)")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string78 = _("Financial Services")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string79 = _("Governance and Partnership")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string80 = _("Infrastructure (non - WASH, non - energy)")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string81 = _("Nutrition")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string82 = _("Public Health (non - nutrition, non - WASH)")
# Translators: One of several choices for what label/sector (i.e. development domain) a program is most closely associated with
string83 = _("WASH")
