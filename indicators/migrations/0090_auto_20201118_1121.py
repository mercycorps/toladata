# Generated by Django 2.2.14 on 2020-11-18 19:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='baseline',
            field=models.CharField(blank=True, help_text='Enter a numeric value for the baseline. If a baseline is not yet known or not applicable, enter a zero or select the &ldquo;Not applicable&rdquo; checkbox. The baseline can always be updated at later point in time.', max_length=255, null=True, verbose_name='Baseline'),
        ),
        migrations.AlterField(
            model_name='indicator',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(choices=[(1, 'Not applicable'), (2, 'Increase (+)'), (3, 'Decrease (-)')], default=1, help_text="Is your program trying to achieve an increase (+) or decrease (-) in the indicator's unit of measure? This field is important for the accuracy of our &ldquo;indicators on track&rdquo; metric. For example, if we are tracking a decrease in cases of malnutrition, we will have exceeded our indicator target when the result is lower than the target.", null=True, verbose_name='Direction of Change'),
        ),
        migrations.AlterField(
            model_name='indicator',
            name='disaggregation',
        ...
        migrations.AlterField(
            ...
            field=models.TextField(blank=True, help_text='Select any quality assurance measures specific to this indicator.', max_length=500, null=True, verbose_name='Quality assurance measures'),
        ),
        migrations.AlterField(
            model_name='indicator',
